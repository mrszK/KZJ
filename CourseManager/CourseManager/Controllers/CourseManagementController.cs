...
namespace CourseManager.Controllers
{
    public class CourseManagementController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ClassId,CouseId,TeacherId")] CourseManagements courseManagements)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ClassId,CouseId,TeacherId")] CourseManagements courseManagements)
        {
            if (ModelState.IsValid)
            {
